...
from swagger_server.models.data_job_info_data_request import DataJobInfoDataRequest  # noqa: F401,E501
...
class DataJobInfo(Model):
    ...
    """
    def __init__(self, data_access_method: str=None, data_request: DataJobInfoDataRequest=None, data_access_uri: str=None):  # noqa: E501
    ...
    @property
    def data_request(self) -> DataJobInfoDataRequest:
    ...
    @data_request.setter
    def data_request(self, data_request: DataJobInfoDataRequest):
