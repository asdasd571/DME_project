...
class ProblemDetails(Model):
    ...
    """
    def __init__(self, type: str=None, title: str=None, status: int=None, detail: str=None, instance: str=None):  # noqa: E501
    ...
    def title(self) -> str:
        ...
        A short, human-readable title of the error.  # noqa: E501
    ...
    def status(self) -> int:
        ...
        The HTTP status code generated by the server.  # noqa: E501
    ...
    def instance(self) -> str:
        ...
        A unique instance identifier for the problem occurrence.  # noqa: E501
