...
from swagger_server.models.data_delivery_mechanism import DataDeliveryMechanism  # noqa: F401,E501
from swagger_server.models.delivery_schema import DeliverySchema  # noqa: F401,E501
from swagger_server.models.dme_type_id_struct import DmeTypeIdStruct  # noqa: F401,E501
...
class DmeTypeDefinition(Model):
    ...
    def dme_type_id(self, dme_type_id: DmeTypeIdStruct):
        ...
        :type dme_type_id: DmeTypeIdStruct
        """
        if dme_type_id is None:
            raise ValueError("Invalid value for `dme_type_id`, must not be `None`")  # noqa: E501
    ...
    def data_delivery_schemas(self, data_delivery_schemas: List[DeliverySchema]):
        ...
        :type data_delivery_schemas: List[DeliverySchema]
        """
        if data_delivery_schemas is None:
            raise ValueError("Invalid value for `data_delivery_schemas`, must not be `None`")  # noqa: E501
    ...
    def data_delivery_mechanisms(self, data_delivery_mechanisms: List[DataDeliveryMechanism]):
        ...
        :type data_delivery_mechanisms: List[DataDeliveryMechanism]
        """
        if data_delivery_mechanisms is None:
            raise ValueError("Invalid value for `data_delivery_mechanisms`, must not be `None`")  # noqa: E501
