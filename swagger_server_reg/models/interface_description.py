...
from swagger_server_reg.models.o_auth_grant_type import OAuthGrantType  # noqa: F401,E501
from swagger_server_reg.models.security_method import SecurityMethod  # noqa: F401,E501
...
class InterfaceDescription(Model):
    ...
    """
    def __init__(self, ipv4_addr: str=None, ipv6_addr: str=None, fqdn: str=None, port: int=None, api_prefix: str=None, security_methods: List[SecurityMethod]=None, grant_types: List[OAuthGrantType]=None):  # noqa: E501
